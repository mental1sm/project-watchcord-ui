export function IconHash({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
...
export function IconVolume({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
...
export function IconMessageCircleFilled({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
...
export function IconJoinRound({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
             className="icon icon-tabler icons-tabler-outline icon-tabler-join-round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            <path
...
export function IconCalendarClock({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
...
export function IconBrandGithub({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none"
             stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
...
export function IconCategory({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none"
             stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
...
export function IconInfoSquareRounded({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none"
             stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
...
export function IconSettings({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none"
             stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
...
export function IconRefresh({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none"
             stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
...
export function IconLayoutSidebarLeftExpand({stroke = 2, size = 24, className = ""}: { stroke?: number, size?: number, className?: string}) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none"
             stroke="currentColor" strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round"
...
export function IconLayoutSidebarLeftCollapse({stroke = 2, size = 24, className = ""}: {
    stroke?: number,
    size?: number,
    className?: string
}) {
...
export function IconTrash({stroke = 2, size = 24, className = ""}: {
    stroke?: number,
    size?: number,
    className?: string
}) {
...
export function IconPlus({stroke = 2, size = 24, className = ""}: {
    stroke?: number,
    size?: number,
    className?: string
}) {
...
export function IconFolderOpen({stroke = 2, size = 24, className = ""}: {
    stroke?: number,
    size?: number,
    className?: string
}) {
...
export function IconEdit({stroke = 2, size = 24, className = ""}: {
    stroke?: number,
    size?: number,
    className?: string
}) {
...
export function IconArrowRight({stroke = 2, size = 24, className = ""}: {
    stroke?: number,
    size?: number,
    className?: string
}) {
    return (
        ...
        strokeWidth={stroke}  strokeLinecap="round"  strokeLinejoin="round"  className="icon icon-tabler icons-tabler-outline icon-tabler-arrow-right">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            <path d="M5 12l14 0" />
            <path d="M13 18l6 -6" />
            <path d="M13 6l6 6" />
